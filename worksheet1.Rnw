...
\begin{tabular}{| c | c |}
\hline
Bayes' factor & Strength of evidence for/against first model or hypothesis \\
\hline \hline
$10$ to $\infty$ & Strong for \\
\hdashline[1pt/5pt]
$3$ to $10$ & Substantial for \\
 \hdashline[1pt/5pt]
$1$ to $3$ & Barely worth mentioning for \\
 \hdashline
$1/3$ to $1$ & Barely worth mentioning against \\
\hdashline[1pt/5pt]
$0.1$ to $1/3$ & Substantial against \\
\hdashline[1pt/5pt]
$-\infty$ to $0.1$ & Strong against \\
\hline
\end{tabular}
\caption{The regions of Jeffreys' scale for interpreting the Bayes' factor.}
\label{tab:Jeffreys}
\end{table}
%% \begin{tabular}{| c | c |}
%%     \hline
...
%% Compile in R using knit("worksheet1.Rnw")
